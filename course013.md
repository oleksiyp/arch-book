# Course 13: Platform Engineering and the Capstone
...
Unlike every course before it, this one is mostly *doing*: roughly half the course effort is the capstone project. Students design a complete platform for a scaling case-study company — golden paths, platform APIs, event and data infrastructure, security guardrails, AI services, migration roadmap, and an executive narrative — reviewed against the trade-off discipline built across all twelve prior courses.

**Primary sources:** *Building Evolutionary Architectures* (Ford, Parsons, Kua, Sadalage), *Software Architecture Metrics* (Ciceri et al.), *The Software Architect Elevator* (Hohpe), *Technology Strategy Patterns* (Hewitt), *Enabling Microservice Success* (Watt); *Learning Systems Thinking* (Montalion) as companion reading
...
- Composing prior courses into planes: compute (Course 10), events (6), data (8), APIs (7), AI services (11), tenancy (12)
